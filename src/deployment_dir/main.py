...
model_name= os.environ.get('COMET_ML_MODEL_NAME')
...
try:
    ...
    import os
    COMET_ML_WORKSPACE = os.environ.get("COMET_ML_WORKSPACE")
    COMET_ML_API_KEY = os.environ.get("COMET_ML_API_KEY")
    COMET_ML_MODEL_NAME = os.environ.get('COMET_ML_MODEL_NAME')
